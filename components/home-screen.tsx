    ...
    <div className="flex flex-col pb-6" dir={dir}>
      ...
      <div className="mt-6 px-6">
        ...
        <div className="mt-3 flex flex-col gap-3">
          {[
            {
              name: locale === "ar" ? "تنظيف منزل عميق" : "Deep Home Cleaning",
              price: locale === "ar" ? "٣٥٠ ج.م" : "350 EGP",
              time: locale === "ar" ? "٣-٤ ساعات" : "3-4 hrs",
              rating: "4.9",
            },
            {
              name: locale === "ar" ? "تجميل حيوانات أليفة" : "Pet Grooming",
              price: locale === "ar" ? "٢٠٠ ج.م" : "200 EGP",
              time: locale === "ar" ? "١-٢ ساعة" : "1-2 hrs",
              rating: "4.8",
            },
          ].map((item) => (
            <div
