      ...
      <div className="flex flex-1 flex-col px-6 pt-6 pb-4">
        ...
        <div className="mt-5 flex gap-2 rounded-xl bg-muted p-1">
          <button
            ...
            className={`flex flex-1 items-center justify-center gap-2 rounded-lg px-3 py-2.5 text-sm font-medium transition-all ${authMode === "phone"
          ...
          <button
            ...
            className={`flex flex-1 items-center justify-center gap-2 rounded-lg px-3 py-2.5 text-sm font-medium transition-all ${authMode === "email"
                ? "bg-card text-foreground shadow-sm"
                : "text-muted-foreground"
              }`}
          >
